...
auto combinations_aux(
    ...
    return combine(
        combinations_aux(sizes, max_count, acc + sizes[off], count + 1, off + 1, def, combine, project),
        combinations_aux(sizes, max_count, acc, count, off + 1, def, combine, project));
}
...
int main(int argc, char **argv) {
    ...
    fmt::print("part 2: {}\n", combinations(sizes, min_containers, 0, std::plus{}, [](int count) { return 1; }));
